...
<section class="page-hero">
    <div class="container">
        <h2><?php echo esc_html__('Stream', 'pixiefreak') ?></h2>
        <h4><?php echo esc_html__('This is where you can browse through our tournaments', 'pixiefreak') ?></h4>
    </div>
</section>
    ...
    <section class="news">
        <div class="section-header">
            <div class="section-title normal">
                <h2><?php echo esc_html__('Stream Page', 'pixiefreak'); ?></h2>
            </div>
        </div>
        ...
        <div class="tab-content content">
            <div id="all" class="active">
                ...
                <?php else: ?>
                    <iframe width="100%"
                            height="520"
                            src="<?php echo esc_url('//player.twitch.tv/?channel=' . substr($stream->link, strrpos($stream->link, '/') + 1));?>&parent=<?php echo esc_attr(str_replace($protocols, '', home_url())); ?>"
                            frameborder="0"
                            allowfullscreen>
                    </iframe>
                <?php endif; ?>
