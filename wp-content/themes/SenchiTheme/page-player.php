            ...
            <div class="inner-body">
                <article class="top">
                    <div class="col left detail-left-list">
                        <ul>
                            <li>
                                <span class="label"><?php echo esc_html__('Current Team', 'pixiefreak'); ?></span>
                                <span class="name"><?php echo esc_html($team->name); ?></span>
                            </li>

                            <li>
                                <span class="label"><?php echo esc_html__('Player Age', 'pixiefreak'); ?></span>
                                <span class="name"><?php echo esc_html($player->birth_date); ?></span>
                            </li>

                            <li>
                                <span class="label"><?php echo esc_html__('Ingame Role', 'pixiefreak'); ?></span>
                ...
                <article class="bottom">
                    <div class="col left textarea">
                        <div class="text-head">
                            <h4>
	                            <?php echo esc_html__('Player Bio', 'pixiefreak'); ?>
                            </h4>
                    ...
                    <div class="col right">
	                    ...
	                    <?php if (!empty($statistics = json_decode($player->stats, true))): ?>
                            <ul class="stats player-stats">
                                <?php foreach ($statistics as $statistic): ?>
                                    <li>
                                        <i class="icon" style="background-image: url('<?php echo esc_html($statistic['icon']); ?>');"></i>
                                        <h5><?php echo esc_html($statistic['title']); ?></h5>
                                        <span><?php echo esc_html($statistic['label']); ?></span>
                                    </li>
			                    <?php endforeach; ?>
                            </ul>
	                    <?php endif; ?>
            ...
            <div class="gear-list">
                <div class="section-header col-white">
                    ...
                    <div class="section-title normal">
                        <h2><?php echo esc_html__('Player Gear', 'pixiefreak'); ?></h2>
                        <span><?php echo esc_html__('Our roster our pride all on one place', 'pixiefreak'); ?></span>
                    </div>
                </div>
                                ...
                                <div class="card-info">
                                    <div class="card-info-pad">
                                        ...
                                        <span class="label text-uppercase label-green">
                                            <?php echo esc_html__('New', 'pixiefreak'); ?>
                                        </span>
                                        <?php endif; ?>
                                        ...
                                        <span class="subtitle">
                                            <?php if ($gear->type == 0): ?>
                                                <?php echo esc_html__('Mouse', 'pixiefreak'); ?>
                                            <?php elseif ($gear->type == 1): ?>
                                                <?php echo esc_html__('Headphones', 'pixiefreak'); ?>
                                            <?php else: ?>
                                                <?php echo esc_html__('Keyboard', 'pixiefreak'); ?>
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                    ...
                                    <?php if (!empty($gear->link)): ?>
                                        <a href="<?php echo esc_url($gear->link); ?>" class="btn btn-default">
                                            <?php echo esc_html__('Buy now', 'pixiefreak'); ?>
                                        </a>
                                    <?php endif; ?>
                                </div>
                                <figure class="center">
            ...
            <div class="container">
                <div class="section-header border-bottom">
                    ...
                    <div class="section-title">
                        <h2><?php echo esc_html__('View player streams', 'pixiefreak'); ?></h2>
                    </div>
                </div>
                <div class="tab-content">
