...
<section class="page-hero">
    <div class="container">
        <h2><?php echo esc_html__('News page', 'pixiefreak') ?></h2>
        ...
        <div class="news">
            <div class="section-header">
                <div class="section-title normal">
                    <h2><?php echo esc_html__('News Feed', 'pixiefreak'); ?></h2>
                </div>
                <ul>
                    <li class="active">
                        <a href="#all" data-toggle="tab" class="msnry"><?php echo esc_html__('All', 'pixiefreak'); ?></a>
                    </li>
