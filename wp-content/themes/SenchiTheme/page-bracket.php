...
?>
    ...
    <section class="page-hero">
        <div class="container">
            <h2>
		        <?php echo esc_html__('More Info about the brackets!', 'pixiefreak'); ?>
            </h2>
            <h4>
                <?php echo esc_html__('Random text brackets related goes here', 'pixiefreak'); ?>
            </h4>
            <ul class="tab-nav">
                <li>
                    <a href="<?php echo pixiefreak_route('tournament', $tournament->slug); ?>" class="btn-default active">
		                <?php echo esc_html__('Back to tournament', 'pixiefreak'); ?>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <section class="brackets page-bg">
        <div class="container">
            ...
            <div class="bracket-wrapper">
                <div id="panzoom-element" class="panzoom-elements"></div>
            </div>
        </div>
    </section>
<?php get_footer(); ?>
