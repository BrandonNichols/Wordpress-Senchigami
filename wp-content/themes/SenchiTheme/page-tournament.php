...
<section class="tournament inner-page">
    <div class="container">
        ...
        <div class="inner-body">
            ...
            <article class="bottom">
                ...
                <div class="col left textarea">
                    <div class="text-head">
                        <h4><?php echo esc_html__('About the tournament', 'pixiefreak'); ?></h4>
                ...
                <div class="col right">
                    <ul class="stats stats-tournament">
                        <li>
                            <h5><?php echo esc_html($tournament->team_number); ?> <?php echo esc_html__('Teams', 'pixiefreak'); ?></h5>
                            <span><?php echo esc_html__('Round robin', 'pixiefreak'); ?></span>
                        </li>
                        <li>
                            <h5><?php echo esc_html($groups->count()); ?> <?php echo esc_html__('Groups', 'pixiefreak'); ?></h5>
                            <span><?php echo esc_html(\PixieFreakPanel\Model\Tournament::query()->playersCount($tournament)); ?> <?php echo esc_html__('Players', 'pixiefreak'); ?></span>
                        </li>
                        <li>
                            <h5><?php echo esc_html__('Prize pool', 'pixiefreak'); ?></h5>
        ...
        <div class="teams">
            ...
            <div class="inner-page-header mb">
                <div class="headline">
                    <h4><?php echo esc_html__('Meet the competitors', 'pixiefreak'); ?></h4>
	...
	<?php if (!empty(\PixieFreakPanel\Model\Tournament::query()->brackets($tournament))): ?>
        <div class="view-brackets">
            <div class="section-header col-white center-column">
                <div class="section-title">
                    <span><?php echo esc_html__('Want to see how the playout?', 'pixiefreak'); ?></span>
                    <h2><?php echo esc_html__('Teams Clashing it up!', 'pixiefreak'); ?></h2>
                </div>

                <a href="<?php echo pixiefreak_route('bracket', $tournament->slug); ?>" class="btn-default" target="_blank">
					<?php echo esc_html__('View Brackets', 'pixiefreak'); ?>
                </a>
            </div>
        </div>
	<?php endif; ?>
        ...
        <div class="match-schedule">
            <div class="container">
                <div class="section-header">
                    <div class="section-title">
                        <span><?php echo esc_html__('Check out our', 'pixiefreak'); ?></span>
                        <h2><?php echo esc_html__('Match Schedule', 'pixiefreak'); ?></h2>
                    </div>
                    ...
                    <ul class="tab-nav">
                        <li>
                            <a class="btn-default previous-day">
								...
								<?php echo esc_html__('Previous Day', 'pixiefreak'); ?>
                            </a>
                        </li>

                        <li>
                            <a class="btn-default next-day">
								<?php echo esc_html__('Next Day', 'pixiefreak'); ?>
                                    ...
                                    <a href="<?php echo pixiefreak_route('match', $match->slug); ?>" class="match-details">
                                        ...
                                        <div class="match-info">
                                                <span>
	                                                ...
	                                                <?php echo esc_html__('Starts at', 'pixiefreak'); ?>
        ...
        <div class="matches page-bg">
            <div class="container">
                <div class="inner-page-header">
                    <div class="headline">
                        <h4><?php echo esc_html__('Matches related to tournament', 'pixiefreak'); ?></h4>
                        <span><?php echo esc_html__('Random tag line goes here', 'pixiefreak'); ?></span>
                    </div>
                </div>
										...
										<?php if (count($tournament) > 0): ?>
                                            ...
                                            <span class="date">
                                                ...
                                                <a href="<?php echo pixiefreak_route('match', $match->slug); ?>">
                                                        <?php echo esc_html__('View match', 'pixiefreak'); ?>
                            ...
                            <div class="overlay">
                                ...
                                <span class="date">
									...
									<?php if (is_sticky($post->ID)): ?>
                                        <span class="sticky">
                                        <i class="fas fa-map-pin"></i> <?php echo esc_html__('Sticky', 'pixiefreak'); ?>
                                    </span>
									<?php endif; ?>
                                </div>
                            </div>
