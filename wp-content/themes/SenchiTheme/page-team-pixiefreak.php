            ...
            <div class="inner-body">
                <article class="top">
                    <div class="col left about">
                        ...
                        <div class="details">
                            ...
                            <p>
                                <?php echo esc_html__('Founded', 'pixiefreak'); ?> <?php echo esc_html(date_i18n("d M  Y", strtotime($team->year_founded))); ?>
                            </p>
                        </div>
                    </div>
                            ...
                            <ul class="info-list">
			                    <?php foreach ($statistics as $key => $value): ?>
                                    <li>
                                        ...
                                        <span class="subtitle">
                                            <?php if ($key == 'win'): ?>
                                                <?php esc_html_e('Win', 'pixiefreak') ?>
                                            <?php elseif($key == 'loses'): ?>
	                                            <?php esc_html_e('Loses', 'pixiefreak') ?>
                                            <?php else: ?>
	                                            <?php esc_html_e('Tie', 'pixiefreak') ?>
                                            <?php endif; ?>
                                        </span>
                                    </li>
			                    <?php endforeach; ?>
                ...
                <article class="bottom">
                    <div class="col left textarea">
                        <div class="text-head">
                            <h4><?php echo esc_html__('About the team', 'pixiefreak'); ?></h4>
		                        ...
		                        <?php foreach ($players as $player): ?>
                                    ...
                                    <li class="card">
                                        ...
                                        <div class="card-info">
                                            ...
                                            <a href="<?php echo pixiefreak_route('player', $player->slug); ?>" class="btn btn-default"><?php echo esc_html__('Profile', 'pixiefreak'); ?></a>
                                        </div>
                                    </li>
